"""
Django settings for SHARE Bear project.
...
# Email (Gmail SMTP). Set in .env locally and in Vercel project env vars.
...
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER', '')  # e.g. yourname@gmail.com
